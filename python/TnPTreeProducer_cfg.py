...
registerOption('era',         '2018',   'Data-taking era: 2016, 2017, 2018, UL2017, UL2018 or Run3', optionType=VarParsing.varType.string)
...
if varOptions.era not in ['2016', '2017', '2018', 'UL2017', 'UL2018', 'Run3']: log.error('%s is not a valid era' % varOptions.era)
if ('UL' in varOptions.era)!=(isReleaseAbove(10, 6)) and not varOptions.era=='Run3':
